...
import (
	...
	"github.com/poleljy/kube-boost/errors"
	metricapi "github.com/poleljy/kube-boost/integration/metric/api"
	"github.com/poleljy/kube-boost/resource/common"
	"github.com/poleljy/kube-boost/resource/dataselect"
	"github.com/poleljy/kube-boost/resource/event"
	"github.com/poleljy/kube-boost/resource/pod"
)
...
type NodeAllocatedResources struct {
	...
	// GPULimits is defined GPU limit.
	GPULimits int64 `json:"gpuLimits"`

	// GPUCapacity is specified node GPU capacity.
...
func getNodeAllocatedResources(node v1.Node, podList *v1.PodList) (NodeAllocatedResources, error) {
	...
	// GPU
	var gpuCapacity int64 = 0
	if val, ok := node.Status.Allocatable["nvidia.com/gpu"]; ok {
		gpuCapacity = val.Value()
	}

	var gpuLimits int64 = 0
