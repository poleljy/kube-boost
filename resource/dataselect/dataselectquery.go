...
func NewLabelSelectQuery(labels map[string]string) *DataSelectQuery {
	return &DataSelectQuery{
		PaginationQuery: NoPagination,
		SortQuery:       NoSort,
		FilterQuery:     NoFilter,
		MetricQuery:     NoMetrics,
		LabelSelector:   NewLabelSelector(labels),
	}
}
